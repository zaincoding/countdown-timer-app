...
export default function Countdown() {
  ...
  const handleSetDuration = (): void => {
    if (typeof duration === "number" && duration > 0) {
     let timeInSecond = duration*60;
      setTimeLeft(timeInSecond); // Set the countdown timer
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-blue-300 dark:bg-gray-900">
      {/* Timer box container */}
      <div className="bg-gray-300 dark:bg-blue-700 shadow-lg rounded-lg p-8 w-full max-w-md">
        ...
        <div className="flex items-center mb-6">
          <Input
            type="number"
            id="duration"
            placeholder="Enter duration in minuts"
            value={duration}
            onChange={handleDurationChange}
            className="flex-1 mr-4 rounded-md border-blue-500 bg-blue-100"
          />
          <Button
            onClick={handleSetDuration}
            variant="outline"
            className="text-blue-900 border-blue-500 bg-blue-100"
          >
            Set
          </Button>
        </div>
        ...
        <div className="flex justify-center gap-4">
          <Button
            onClick={handleStart}
            variant="outline"
            className="text-blue-900 border-blue-500 bg-green-100"
          >
